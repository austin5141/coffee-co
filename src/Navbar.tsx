        ...
        <>
            <nav className="bg-rose-900 p-7 flex items-center justify-between font-poppins">
                ...
                <div className="mr-10 font-light hidden md:block">
                    ...
                    <NavLink to="/order/" className="text-white mr-5 transition-transform hover:font-extrabold hover:scale-125 relative">
            ...
            {navMenuOpen 
            ? (<div className="flex flex-col items-end bg-rose-500 w-60 fixed right-0 h-screen">
                <button className="mr-5 mt-10 text-rose-950 font-bold text-3xl" onClick={() => setNavMenuOpen(false)}>X</button>
                    <NavLink to="/" className="text-rose-950 text-2xl mt-10 mr-5 transition-transform hover:font-extrabold hover:scale-125">Home </NavLink>
                    <NavLink to="/menu/" className="text-rose-950 text-2xl mt-10 mr-5 transition-transform hover:font-extrabold hover:scale-125">Menu</NavLink>
                    <NavLink to="/review/" className="text-rose-950 text-2xl mt-10 mr-5 transition-transform hover:font-extrabold hover:scale-125">Review Us</NavLink>
            </div>) 
            : null}
        </>
    )
